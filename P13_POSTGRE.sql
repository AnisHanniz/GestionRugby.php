/*  Création et Alimentation des tables en MYSQL */
...
/*	Ayant trouvé la méthode d'insertion précedente (qu'a l'air de bien marcher et plus courte) on laisse celle qu'on a utilisé en tp ci-dessous	*/
/*
INSERT INTO P13_jouer(j_id,eq_id) VALUES ((select j_id from P13_joueur where j_id = 1),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 2),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 3),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 4),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 5),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 6),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 7),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 8),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 9),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 10),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 11),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 12),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 13),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 14),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 15),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 16),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 17),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 18),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 19),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 20),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 21),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 22),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 23),
					(select eq_id from P13_equipe where eq_id = 1)),
					((select j_id from P13_joueur where j_id = 24),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 25),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 26),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 27),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 28),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 29),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 30),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 31),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 32),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 33),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 34),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 35),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 36),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 37),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 38),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 39),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 40),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 41),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 42),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 43),
					(select eq_id from P13_equipe where eq_id = 2)),
					((select j_id from P13_joueur where j_id = 44),
					(select eq_id from P13_equipe where eq_id = 2));
